	          ...
	          <table id="userTable" class="display table-striped table-hover table-bordered" style="width: 100%;"">
				...
				?>
			        <tr>
			            ...
			            <td class="text-center"><a href="<?php echo base_url(); ?>admin/user/delete/<?php echo $user->userid; ?>"><img  src='<?php echo base_url(); ?>assets/images/delete.png' width="20px" height="20px" title="Delete" onClick="return doconfirm();" ></a></td>
