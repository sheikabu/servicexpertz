    ...
    <div class="col-md-12 col-sm-12">      
      <div class="row">
          <div class="col-md-6 col-md-offset-3 mt-20">
              <form class="form-horizontal" id="categories_form" action="<?php echo base_url() ?>admin/servicecategories/insert" method="post" enctype="multipart/form-data">
                ...
                <div class="col-sm-12">
                     <select class="form-control" name="main_category_id"  id="mainservice" required> 
                      ...
                      <?php foreach ($servicesubcategories as $key => $value) { ?>
                      <option value="<?php echo $value->smc_id; ?>"><?php echo $value->main_category_id; ?> </option>
                      <?php } ?>                      
              ...
              <div class="form-group">
                <label class="control-label col-sm-12" for="lastname">Categories <span class="validationerror">*</span></label>
               <div class="col-sm-12">
                     <select class="form-control" name="main_category_id"  id="mainservice" required> 
                      <option value="">Select Main Service Categories</option>
                      <?php foreach ($servicesubcategories as $key => $value) { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">          
                  <input type="text" class="form-control" id="sub_categories" placeholder="Enter Sub Categories" name="category" value="" required>
                </div>
              </div>
