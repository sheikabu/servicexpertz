 ...
 <div id="mySidenav" class="col-sm-3 sidenav">
          ...
          <li><a href="<?php echo base_url(); ?>admin/home"><i class="fa fa-tachometer mr-3" aria-hidden="true"></i>Dashboard</a></li>
            ...
            <li><a href="<?php echo base_url(); ?>admin/serviceprovider/list_sp"><i class="fa fa-cogs mr-3" aria-hidden="true"></i>Service Providers</a></li>
			     <li><a href="<?php echo base_url(); ?>admin/servicecategories/list_servicecategories"><i class="fa fa-sitemap mr-3" aria-hidden="true"></i>Categories</a></li>
            <li><a href="<?php echo base_url(); ?>admin/servicesubcategories/list_servicesubcategories"><i class="fa fa-sitemap mr-3" aria-hidden="true"></i>Sub Categories</a></li>
